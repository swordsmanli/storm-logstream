...
class DBHelperMethod {
	...
	public static DBCollection createCappedDBCollection(String mongHost, int mongoPort, 
		...
		collection = db.createCollection(collectionName, 
				new BasicDBObject("capped", true).append("size", 100000000));
		return collection;
	}
}
...
public class LogStreamTopology {
	...
	public static void main(String[] args) throws UnknownHostException, AlreadyAliveException, InvalidTopologyException, InterruptedException {
		// TODO Auto-generated method stub
		final String mongoHost ="10.65.43.129"; //"10.65.43.129";"10.65.45.107";
		final int mongoPort = 8500;
		final String spoutDbName = "online";//"online";
		final String spoutCollectionName = "imas";//"imas";
		final String boltDbName = "logstream";//"online";
		final String boltCollectionName = "imas";
		final String lostYear = "2013";
		//log counter forms as (key, value) pairs
		final String logAccountKey = "idc";
		final String logAccountValue = "tt";
		...
		MongoToTupleFormatter formatter = new MongoToTupleFormatter() {
			...
			public DBObject mapTupleToDBObject(DBObject object, Tuple tuple) {
				...
				return BasicDBObjectBuilder.start()
						...
						//.add("imas_ar_time", tuple.getDoubleByField("averagesum"))
		...
		//add spout and bolts
		builder.setSpout("baidu-log", spout, 1);
		builder.setBolt("sum", new MongoAccoutBolt<Object>(lostYear, intervalTime, 
				logAccountKey, logAccountValue), 1).allGrouping("baidu-log");
